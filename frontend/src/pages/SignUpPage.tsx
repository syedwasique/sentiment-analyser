...
export function SignUpPage() {
  const { signUpWithEmail, signInWithGoogle, continueAsGuest } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-[1000px] pointer-events-none">
        <div className="absolute top-[20%] right-[20%] w-[40%] h-[40%] bg-cyan-500/10 blur-[120px] rounded-full" />
        <div className="absolute bottom-[20%] left-[20%] w-[40%] h-[40%] bg-blue-500/10 blur-[120px] rounded-full" />
      </div>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <p className="mt-2 text-center text-sm text-slate-600">
          ...
          <Link to="/signin" className="font-medium text-cyan-600 hover:text-cyan-500 transition-colors">
            Sign in
          </Link>
        </p>
      </div>

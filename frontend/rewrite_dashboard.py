...
dashboard_path = r"c:\Users\user\OneDrive\Desktop\sentiment\Fyp-sentiment-analyser\frontend\src\pages\DashboardPage.tsx"

part1 = """import React, { useState, useEffect, useRef, useMemo } from 'react';
    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans selection:bg-brand/20">
      ...
      <header className="h-14 bg-card border-b border-border px-4 flex items-center justify-between z-30 sticky top-0 backdrop-blur-md">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 rounded-xl bg-slate-950 border border-cyan-500/40 flex items-center justify-center p-1 shadow-md flex-shrink-0">
              <img src="/logo.png" alt="MindPulse Logo" className="w-full h-full object-contain drop-shadow-[0_0_6px_rgba(6,182,212,0.6)]" />
            </div>
...
with open(dashboard_path, "w", encoding="utf-8") as f:
    f.write(part1 + part2 + part3 + part4 + part5 + part6)
